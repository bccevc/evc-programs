...
if (dataFile)   {  
  ...
  int echour = hour - 5;
  dataFile.print("  Time: "); dataFile.print(echour, DEC); dataFile.print(":"); 
  ...
  dataFile.print("Course (degrees): "); dataFile.println(gps.f_course()); 
  // And same goes for speed
  dataFile.print("Speed(kmph): "); dataFile.println(gps.f_speed_kmph());
  ...
  int echour = hour - 5;
  Serial.print("  Time: "); Serial.print(echour, DEC); Serial.print(":"); 
